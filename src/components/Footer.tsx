      ...
      <div className="relative py-10 sm:py-14 lg:py-16">
        <div className="max-w-[1200px] mx-auto px-5 sm:px-6 lg:px-8">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12">
            ...
            <div className="sm:col-span-2 lg:col-span-1">
              ...
              <div className="flex gap-2.5 mt-5 sm:mt-6">
                <a
                  ...
                  aria-label="WhatsApp"
                  className="w-9 h-9 sm:w-10 sm:h-10 rounded-xl bg-white/70 border border-white/80 flex items-center justify-center hover:bg-white hover:shadow-md hover:shadow-coral/10 hover:-translate-y-0.5 transition-all duration-200"
                >
                  <svg width="16" height="16" viewBox="0 0 24 24" fill="#25D366" className="sm:w-[18px] sm:h-[18px]">
                ...
                <a
                  ...
                  className="w-9 h-9 sm:w-10 sm:h-10 rounded-xl bg-white/70 border border-white/80 flex items-center justify-center hover:bg-white hover:shadow-md hover:shadow-coral/10 hover:-translate-y-0.5 transition-all duration-200"
                >
                  <svg width="16" height="16" viewBox="0 0 24 24" fill="#229ED9" className="sm:w-[18px] sm:h-[18px]">
                ...
                <a
                  ...
                  className="w-9 h-9 sm:w-10 sm:h-10 rounded-xl bg-white/70 border border-white/80 flex items-center justify-center hover:bg-white hover:shadow-md hover:shadow-coral/10 hover:-translate-y-0.5 transition-all duration-200"
                >
                  <svg width="16" height="16" viewBox="0 0 24 24" fill="#E4405F" className="sm:w-[18px] sm:h-[18px]">
            ...
            {/* Navigation */}
            <div>
              <h4 className="font-[family-name:var(--font-display)] font-bold text-[10px] sm:text-xs uppercase tracking-wider text-coral/60 mb-3 sm:mb-4">
                Навигация
              </h4>
              <nav className="flex flex-col gap-1.5 sm:gap-2">
                {NAV_ITEMS.map((item) => (
                  <button
                    ...
                    className="text-left text-charcoal/55 hover:text-coral text-xs sm:text-sm transition-colors font-[family-name:var(--font-body)] min-h-[32px] sm:min-h-0 flex items-center"
                  >
                    {item.label}
                  </button>
                ))}
            ...
            <div>
              ...
              <div className="flex flex-col gap-1.5 sm:gap-2 text-xs sm:text-sm font-[family-name:var(--font-body)]">
                ...
                <p className="text-charcoal/35 mt-1 sm:mt-2 flex items-center gap-1.5">
            ...
            <div>
              ...
              <div className="bg-white/50 rounded-xl sm:rounded-2xl p-4 sm:p-5 border border-white/60">
                <div className="flex items-center gap-2 mb-2">
                  <div className="w-2 h-2 rounded-full bg-green-400 animate-pulse" />
                  <p className="text-xs sm:text-sm text-charcoal/70 font-[family-name:var(--font-body)] font-medium">
                    Каждый день
                  </p>
                </div>
                <p className="text-lg sm:text-xl font-[family-name:var(--font-display)] font-bold text-charcoal/80">
                  9:00 — 21:00
                </p>
                <div className="mt-3 pt-3 border-t border-charcoal/8 space-y-1">
                  <p className="text-[11px] sm:text-xs text-charcoal/40 font-[family-name:var(--font-body)] flex items-center gap-1.5">
          ...
          {/* Bottom bar */}
          <div className="border-t border-charcoal/8 mt-8 sm:mt-10 pt-5 sm:pt-6 flex flex-col sm:flex-row justify-between items-center gap-3 sm:gap-4">
