        ...
        <div className="grid md:grid-cols-3 gap-6 lg:gap-8 max-w-3xl mx-auto">
          <ScrollReveal delay={0.1}>
            <a
              ...
              className="group block bg-white rounded-2xl p-6 sm:p-8 text-center shadow-md shadow-black/5 border border-border hover:shadow-xl hover:shadow-coral/10 transition-all duration-300 hover:-translate-y-1"
            >
              <div className="w-14 h-14 rounded-2xl bg-green-50 flex items-center justify-center mx-auto mb-4 group-hover:scale-110 transition-transform">
              ...
              <p className="text-gray text-sm font-[family-name:var(--font-body)]">
                Написать сообщение
              </p>
            </a>
          </ScrollReveal>
