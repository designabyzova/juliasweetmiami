...
const BENTO_CAKES: CakeItem[] = [
  ...
  { src: "/cakes-bento/bento-mint-heart-velvet.webp", alt: { ru: "Мятный велюровый бенто-торт в форме сердца — Juliia Sweet на заказ", en: "Mint velvet heart-shaped bento cake — Juliia Sweet Miami custom order" } },
  { src: "/cakes-bento/bento-red-christmas-cyrillic.webp", alt: { ru: "Красный рождественский бенто-торт с надписью «Христос народився!»", en: "Red Christmas bento cake with Cyrillic holiday greeting — custom order" } },
  { src: "/cakes-bento/bento-yellow-pink-birthday.webp", alt: { ru: "Жёлто-розовый бенто-торт с золотым топпером Happy Birthday", en: "Yellow and pink ombre bento cake with gold Happy Birthday topper" }, aspect: "portrait" },
  { src: "/cakes-bento/bento-red-heart-happy-birthday.webp", alt: { ru: "Красный велюровый бенто-торт в форме сердца с серебряной надписью Happy Birthday", en: "Red velvet heart bento cake with silver Happy Birthday medallion" }, aspect: "portrait" },
  { src: "/cakes-bento/bento-pink-heart-birthday-mom.webp", alt: { ru: "Розовый бенто-торт в форме сердца «С днём рождения, мамуля!» — ручная работа", en: "Pink heart bento cake with Happy Birthday Mom inscription — handcrafted" }, aspect: "portrait" },
  { src: "/cakes-bento/bento-red-geometric-heart-love.webp", alt: { ru: "Красный геометрический бенто-торт в форме сердца с надписью Love", en: "Red geometric heart bento cake with Love script — Valentine dessert" }, aspect: "portrait" },
  { src: "/cakes-bento/bento-white-chocolate-birthday.webp", alt: { ru: "Белый бенто-торт с шоколадной надписью Happy Birthday и красными звёздочками", en: "White bento cake with chocolate Happy Birthday lettering and red stars" } },
  { src: "/cakes-bento/bento-pink-heart-teddy-bear.webp", alt: { ru: "Белый бенто-торт с розовым сердцем и фигуркой мишки — детский десерт на заказ", en: "White bento cake with pink heart and teddy bear figurine — kids birthday" } },
  { src: "/cakes-bento/bento-sage-green-love-letter.webp", alt: { ru: "Шалфейно-зелёный бенто-торт с надписью HB my love — авторский дизайн", en: "Sage green bento cake with HB my love lettering — signature design" } },
  { src: "/cakes-bento/bento-red-heart-birthday-love.webp", alt: { ru: "Красный бенто-торт в форме сердца «Happy Birthday, my love» — торт на заказ", en: "Red heart bento cake with Happy Birthday my love — custom order Miami" } },
  { src: "/cakes-bento/bento-white-future-billionaire.webp", alt: { ru: "Белый бенто-торт с шоколадной надписью «Будущему миллиардеру» — подарок на заказ", en: "White bento cake with Future Billionaire chocolate lettering — gift cake" } },
  { src: "/cakes-bento/bento-red-velvet-minimalist.webp", alt: { ru: "Красный минималистичный велюровый бенто-торт — авторский муссовый десерт", en: "Red minimalist velvet bento cake — signature mousse dessert Miami" } },
  { src: "/cakes-bento/bento-yellow-bundt-swirl.webp", alt: { ru: "Жёлтый бенто-торт в форме кугельхопфа с золотыми бусинами — авторский дизайн", en: "Yellow bundt swirl bento cake with gold pearl accents — artisan design" } },
  { src: "/cakes-bento/bento-blue-bubble-cloud.webp", alt: { ru: "Голубой бенто-торт из муссовых сфер с жемчужным декором — облачный дизайн", en: "Blue bubble cloud bento cake with pearl decorations — unique design" } },
  { src: "/cakes-bento/bento-teal-photo-print-star.webp", alt: { ru: "Бирюзовый бенто-торт с фото-принтом и золотой звездой — персональный десерт", en: "Teal bento cake with photo print and gold star topper — personalized" } },
  { src: "/cakes-bento/bento-mint-birthday-candles.webp", alt: { ru: "Мятный бенто-торт с разноцветными свечами Happy Birthday — праздничный десерт", en: "Mint green bento cake with colorful Happy Birthday letter candles" } },
  { src: "/cakes-bento/bento-red-bundt-swirl.webp", alt: { ru: "Красный бенто-торт в форме кугельхопфа — велюровый муссовый десерт", en: "Red bundt swirl velvet bento cake — signature mousse dessert" }, aspect: "portrait" },
  { src: "/cakes-bento/bento-white-pearl-dots.webp", alt: { ru: "Белый минималистичный бенто-торт с серебряными жемчужинами — элегантный десерт", en: "White minimalist bento cake with silver pearl dots — elegant dessert" } },
...
const DESSERTS: CakeItem[] = [
  ...
  { src: "/desserts/mousse-dessert-colorful-assorted-shapes.webp", alt: { ru: "Ассорти муссовых десертов разных форм и цветов — авторская коллекция Juliia Sweet", en: "Colorful assorted mousse desserts in various shapes — Juliia Sweet Miami collection" } },
  { src: "/desserts/mousse-dessert-red-cube-love.webp", alt: { ru: "Красный кубический муссовый десерт с надписью Love — велюровый дизайн", en: "Red velvet cube mousse dessert with Love lettering — signature design" }, aspect: "portrait" },
  { src: "/desserts/mousse-dessert-white-cube-dome-set.webp", alt: { ru: "Набор белых муссовых десертов: кубики и купол — минималистичный дизайн", en: "White mousse dessert set: cubes and dome — minimalist design" } },
  { src: "/desserts/mousse-dessert-red-cube-swirl-quartet.webp", alt: { ru: "Красные муссовые десерты: кубики и спирали — велюровая коллекция на заказ", en: "Red mousse dessert quartet: cubes and swirls — velvet collection" }, aspect: "portrait" },
  { src: "/desserts/mousse-dessert-pink-bubble-butterfly.webp", alt: { ru: "Розовые муссовые десерты из сфер с бабочками — нежная авторская коллекция", en: "Pink bubble mousse desserts with butterfly decorations — delicate pastry art" }, aspect: "portrait" },
  { src: "/desserts/mousse-dessert-red-velvet-collection.webp", alt: { ru: "Коллекция красных велюровых муссовых десертов разных форм с надписью Love", en: "Red velvet mousse dessert collection in various shapes with Love accent" } },
  { src: "/desserts/mousse-dessert-white-pink-butterfly.webp", alt: { ru: "Белые и розовые муссовые десерты с бабочками — нежное кондитерское искусство", en: "White and pink mousse desserts with butterfly accents — delicate pastry" } },
  { src: "/desserts/mousse-dessert-blue-gold-ocean-set.webp", alt: { ru: "Голубые муссовые десерты с золотым градиентом — океанская коллекция на заказ", en: "Blue and gold gradient mousse dessert set — ocean-inspired custom order" } },
  { src: "/desserts/mousse-dessert-white-vanilla-assorted.webp", alt: { ru: "Ассорти белых ванильных муссовых десертов на подставке — элегантная подача", en: "White vanilla assorted mousse desserts on pedestal — elegant presentation" } },
  { src: "/desserts/mousse-dessert-blue-mint-geometric-grid.webp", alt: { ru: "Голубые и мятные геометрические муссовые десерты — коллекция из 9 штук", en: "Blue and mint geometric mousse dessert grid — nine-piece artisan collection" } },
  { src: "/desserts/mousse-dessert-red-racing-birthday.webp", alt: { ru: "Красный глянцевый муссовый десерт с гоночным топпером Happy Birthday — детский праздник", en: "Red glossy mousse dessert with racing Happy Birthday topper — kids party" }, aspect: "portrait" },
  { src: "/desserts/mousse-dessert-white-heart-shell-pearls.webp", alt: { ru: "Белые муссовые десерты в форме сердца и ракушки с жемчужинами", en: "White mousse heart and shell desserts with pearl accents — elegant pastry" } },
  { src: "/desserts/mousse-dessert-four-shapes-colorful.webp", alt: { ru: "Четыре муссовых десерта разных форм и цветов — авторская подача на тарелке", en: "Four colorful mousse desserts in different shapes — artisan platter" } },
  { src: "/desserts/mousse-dessert-purple-bubble-cube-pair.webp", alt: { ru: "Фиолетовые муссовые десерты из сфер в форме кубиков — велюровый дизайн", en: "Purple velvet bubble cube mousse desserts — signature geometric design" } },
  { src: "/desserts/mousse-dessert-mint-bubble-cube-pair.webp", alt: { ru: "Мятные муссовые десерты из сфер в форме кубиков — нежный велюровый дизайн", en: "Mint velvet bubble cube mousse desserts — delicate geometric design" } },
  { src: "/desserts/mousse-dessert-white-geometric-platter.webp", alt: { ru: "Тарелка белых геометрических муссовых десертов — полная авторская коллекция", en: "White geometric mousse dessert platter — complete signature collection" }, aspect: "portrait" },
  { src: "/desserts/mousse-dessert-white-bento-collection.webp", alt: { ru: "Белая коллекция муссовых десертов и бенто-торт — праздничная подача", en: "White mousse dessert and bento cake collection — celebration display" }, aspect: "portrait" },
  { src: "/desserts/mousse-dessert-raspberry-bubble-donut.webp", alt: { ru: "Малиновый муссовый десерт из сфер в форме пончика — авторский дизайн", en: "Raspberry bubble donut mousse dessert — signature artisan design" } },
];
