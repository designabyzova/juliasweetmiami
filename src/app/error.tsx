...
const text = {
  ...
  title: { ru: "Ой!", en: "Oops!" },
  subtitle: {
    ru: "Кажется, что-то пригорело на кухне",
    en: "Looks like something burned in the kitchen",
  },
  description: {
    ru: "Произошла непредвиденная ошибка. Попробуйте обновить страницу или вернуться на главную — наши десерты ждут вас.",
    en: "An unexpected error occurred. Try refreshing the page or head back home — our desserts are waiting for you.",
  },
  cta: { ru: "На главную", en: "Back to Home" },
  ctaRetry: { ru: "Попробовать снова", en: "Try Again" },
};
    ...
    <div className="relative min-h-[100svh] flex items-center justify-center overflow-hidden bg-gradient-warm grain">
      ...
      <div className="relative z-10 text-center px-5 sm:px-8 max-w-2xl mx-auto">
        ...
        >
          {/* Shadow layer */}
          <span
            className="absolute inset-0 font-[family-name:var(--font-display)] font-black text-[100px] xs:text-[120px] sm:text-[160px] md:text-[200px] lg:text-[240px] leading-none select-none"
            style={{
          ...
          {/* Main layer */}
          <h1
            className="relative font-[family-name:var(--font-display)] font-black text-[100px] xs:text-[120px] sm:text-[160px] md:text-[200px] lg:text-[240px] leading-none select-none"
            style={{
        ...
        >
          ...
          <button
            onClick={() => reset()}
            className="btn-pill bg-white/70 backdrop-blur-sm text-charcoal border border-border px-8 py-3.5 sm:px-10 sm:py-4 text-sm sm:text-base font-[family-name:var(--font-display)] hover:bg-white hover:border-coral/30 hover:shadow-lg transition-all duration-300 cursor-pointer"
          >
            {t(text.ctaRetry)}
          </button>
        </motion.div>
